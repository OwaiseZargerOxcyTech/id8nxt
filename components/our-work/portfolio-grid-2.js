...
const projects = [
  {
    ...
    subtitle: "Microsoft _ Fastest Coder Hackathon",
  },
  {
    id: "me-and-tva",
    title: "Me and TVA",
    ...
    subtitle: "Microsoft _ Azure society of excellence",
  },
  {
    id: "nutting-like-it",
  ...
  },
  {
    ...
    category: "Perfume",
    image: "/images/our-work/rome-image.jpg",
    subtitle: "Pepsodent Toothpaste _ Print Ads",
  },
];
...
export default function PortfolioGrid2() {
  return (
    <section className="w-full bg-white">
      <section className="max-w-7xl mx-auto px-4 md:py-20 bg-white">
        {/* Top Row */}
