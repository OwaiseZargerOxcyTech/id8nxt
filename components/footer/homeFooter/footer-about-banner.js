export function FooterAboutBanner() {
  return (
    <div className="relative mx-4 mt-24 mb-12 pb-[2vw] group cursor-pointer flex items-center justify-center">
      ...
      {/* Text content */}
      <div className="relative z-10 text-[14vw] font-normal text-white group-hover:text-black text-center tracking-widest transition-colors duration-300 ease-in-out leading-none">
        LET'S TALK
      </div>
    </div>
  );
