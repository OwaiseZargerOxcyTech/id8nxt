...
export function ContactForm({ backColor }) {
  ...
  return (
    <main className="w-full" style={{ backgroundColor: backColor }}>
      <div className="xl:max-w-6xl 2xl:max-w-screen-xl 3xl:max-w-screen-2xl 4xl:max-w-screen-4xl mx-auto px-4 sm:px-6 pt-16 lg:px-16 flex justify-between items-center min-h-screen">
