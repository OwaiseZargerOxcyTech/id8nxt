    ...
    >
      ...
      >
        <img
          ...
          className="object-cover relative top-16 right-36 w-1/2 2xl:scale-90 h-full z-10"
        />
        <img
          src="/images/about/about-hero/mon-1.png"
          alt="Classical statue 1"
          className="object-cover relative right-[22rem] top-0 w-2/3 2xl:scale-90 h-full z-20"
        />
        <img
          src="/images/about/about-hero/mon-3.png"
          alt="Classical statue 3"
          className="object-cover absolute top-20 right-0 w-[40%] 2xl:scale-90 h-full z-10"
        />
      </div>
    </div>
  );
